...
<nav class="navbar navbar-expand-lg navbar-light bg-light ">
    ...
    <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
        <div class="navbar-nav">
            ...
            <a class="nav-item nav-link active mx-2 mt-2 ml-2" href="#">modifier publication</a>
    ...
    <body>
        ...
        <div>
            ...
            <form method="POST" class="container mt-2">
                <input type="hidden" name="author" id="author" class="form-control mb-3" placeholder="Auteur de l'article" value="<?= $article->getAuthor(); ?>">
                <label>Titre</label>
